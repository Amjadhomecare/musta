        ...
        <div class="text-center w-75 m-auto">
            <div class="auth-logo">
                <a href="index.html" class="logo logo-dark text-center">
                    <span class="logo-lg">
                        <img src="{{ env('logo')}}" alt="" height="88">
                    </span>
                </a>
...
<br>
 ...
 @enderror
        ...
        <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; NEXT META <a href="" class="text-white-50">ERP</a> 
        </footer>
