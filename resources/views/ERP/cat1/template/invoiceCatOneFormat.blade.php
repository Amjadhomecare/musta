    ...
    <div class="main">
        <div class="row mx-0">
            <div class="col-7">
                <div class="d-flex   p-4   align-items-center">
                    <div>
                        <img style="width: 90px; height: 90px; padding-right: 20px;" class="logo"
                            src=" {{ env('logo') }}" alt="">
        ...
        <div class="section">
                ...
                <div style="width:450px" class="section1">
                    <div class="  w-100 p-1   d-flex justify-content-end   mx-0  ">
                        ...
                        <div class="d-flex col-6  align-items-center">
                            {{$invDetails?->accountLedger?->ledger}} | {{$invDetails?->customerInfo?->phone}}
                        </div>
                    </div>
                    ...
                    <div class="  w-100 p-1   d-flex justify-content-end   mx-0  ">
                        <div class="col-6      d-flex justify-content-center  ">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-dark">تفاصيل العقد</span>
                            </div>

                        </div>
                        <div class="d-flex col-6       align-items-center">
                            <span class="normalFont text-dark subtitle">Start Date:
                                {{$invDetails?->contractInfo?->started_date}} <br>End Date:
                                {{$invDetails?->contractInfo?->ended_date}} </span>
                        </div>
                    </div>
                    <div class="  w-100 p-1   d-flex justify-content-end   mx-0  ">
                        <div class="col-6      d-flex justify-content-center  ">
                        ...
                        <div class="d-flex col-6     align-items-center">
                            <span class="normalFont subtitle text-dark">Name: {{$invDetails?->maidRelation?->name}}
                                <br>Nationality: {{$invDetails?->maidRelation?->nationality}} </span>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <tr class="bg-white text-dark">
                                ...
                                <td class="text-dark td  ">
                                    ...
                                    {{$invDetails?->service_name}}

                                </td>



                                <td class="text-dark td">{{$invDetails?->amount}}</td>
            ...
            <div class=" w-100 d-flex justify-content-center">
                <div class="d-flex justify-content-between w-100  ">
                    <table class=" table w-100   mx-3 text-center">
                        ...
                        <tbody>
                            <tr class="bg-white text-dark">
                                <td class="text-dark td">Taxable Value <br> {{$invDetails?->amount}} AED</th>
                                <td class="text-dark td ">Vat% <br> 5%</td>
                                <td class="text-dark  td">Vat <br> {{$invDetails?->amount * 0.05}} </td>
                            </tr>
                    ...
                    <table class=" secondTable table mx-3 text-center">
                        <thead>
                            <tr>
                                ...
                                <td colspan="4" class="text-center">{{$invDetails->amount}} AED </td>
                            </tr>
                        </thead>
                        <thead>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td colspan="4" class="text-center">{{$invDetails?->invoice_balance}} AED </td>
                            </tr>
            ...
            <div class="d-flex justify-content-end">
                <div>
                    <div>Follow Us</div>
                    <div class="subtitle mt-2">GG</div>
                    <div class="mt-2">
                        <img class="contact-icon" src=" {{asset('backend/assets/images/fa-brands_facebook.png') }}"
                            alt="">
