<html xmlns="" lang="en" xml:lang="en"><head>
  ...
  <title> ----company name----</title><style>/**
  * IMPORTANT:
                    ...
                    <td style="border: 0; margin: 0; padding: 0;">
                                  ...
                                  <tr>
                                    <td class="Content Title-copy Font Font--title" align="center" style="border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;width: 472px;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif;mso-line-height-rule: exactly;vertical-align: middle;color: #8898aa;font-size: 15px;line-height: 18px;">
                                        @if($invData->isNotEmpty())
                                            Receipt #: {{$invData->first()->receiveRef}}
                                        @else
                                            <p>No invoice data found for this ID.</p>
                                        @endif
                                    </td>
                                  </tr>
                                  <tr>
                            ...
                            <td width="64" style="border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;color: #ffffff;font-size: 1px;line-height: 1px;mso-line-height-rule: exactly;">&nbsp;</td>
                                ...
                                <table style="border: 0;border-collapse: collapse;margin: 0;padding: 0;">
                                  ...
                                  <tr>
                                    ...
                                    @if($dataDr->isNotEmpty())
                                            AED {{$dataDr->first()->amount}}
                                        @else
                                        <!-- Display a default message or handle the absence of data -->
                                            <p>No amount entries found for this ID.</p>
                                        @endif
                                ...
                                <img alt="Mastercard" height="16" src="https://stripe-images.s3.amazonaws.com/emails/receipt_assets/card/mastercard-dark@2x.png" style="border: 0; margin: 0; padding: 0; vertical-align: text-bottom;" width="75">
                                 <br>
                                    @if($dataDr->isNotEmpty())
                                        {{$dataDr->first()->account}}
                                        @else
                                        <!-- Display a default message or handle the absence of data -->
                                            <p>No debit entries found for this ID.</p>
                                    @endif
                            ...
                            <tr>
                                <td class="Table-description Font Font--body" style="border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif;mso-line-height-rule: exactly;vertical-align: middle;color: #525f7f;font-size: 15px;line-height: 24px; width: 100%; ">
                                    @if($invData->isNotEmpty())
                                        Receipt #: {{$invData->first()->receiveRef}}
                                        For Service: {{$invData->first()->notes}}, Mr/Ms: {{$invData->first()->account}}
                                    @else
                                        <p>No invoice data found for this ID.</p>
                                    @endif
                              ...
                              <tr>
                                ...
                                <td class="Table-description Font Font--body" style="border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif;mso-line-height-rule: exactly;vertical-align: middle;color: #525f7f;font-size: 15px;line-height: 24px; width: 100%; ">
                                    <strong>
                                    @if($dataDr->isNotEmpty())
                                        Amount received by: {{$dataDr->first()->created_by}}
                                    @else
                                        <!-- Display a default message or handle the absence of data -->
                                            <p>No debit entries found for this ID.</p>
                                    @endif
