...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
         <link rel="shortcut icon" href=" {{ env('logo')}} ">
    ...
    <body class="authentication-bg authentication-bg-pattern">
        ...
        <div class="text-center w-75 m-auto">
            <div class="auth-logo">
                <a href="index.html" class="logo logo-dark text-center">
                    <span class="logo-lg">
                        <img src="{{ env('logo') }}" alt="" height="22">
                    </span>
                </a>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <p class="text-black">Back to <a href="{{ route('login') }}" class="text-black ms-1"><b>Sign In</b></a></p>
            </div> <!-- end col -->
        </div>
                        <!-- end row -->
       ...
       <footer class="footer footer-alt">
            2024 - <script>document.write(new Date().getFullYear())</script> &copy; GG<a href="" class="text-white-50">GG</a> 
        </footer>
