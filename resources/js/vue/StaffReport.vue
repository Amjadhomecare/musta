...
const fetchContractReturnsData = async () => {
  const response = await axios.get('https://api.alahliamaids.com/OfficeContractStatus/office-contracts-returns/', {
    params: {
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-lg-6 mb-3 mb-lg-0">
                <h1 class="fs-2x fw-bold text-gray-900 mb-0">📊 Staff Report Homecare & Family Care For Package 4</h1>
