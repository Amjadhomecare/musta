...
const {
  ...
  apiUrl: '/dd-followup/pending',
  queryKeyPrefix: 'dd-follow-pending',
  filters
})
  ...
  <div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
      ...
      <h1 class="d-flex align-items-center text-grey-900 fw-bolder fs-3 my-1 pb-4">
        DD Follow-Ups - Pending (Less than 3 attempts)
      </h1>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
              ...
              <tbody class="fw-semibold text-gray-600">
                ...
                <tr v-for="row in rows" :key="row.id">
                  ...
                  <td>
                    <span class="badge badge-light-primary">{{ row.attempt_number }} / 3</span>
                  </td>
                  <td>
